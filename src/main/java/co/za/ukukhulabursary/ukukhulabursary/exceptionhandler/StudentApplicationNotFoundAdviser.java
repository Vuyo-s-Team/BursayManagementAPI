...
public class StudentApplicationNotFoundAdviser {

       @ResponseBody
    @ExceptionHandler(StudentApplicationNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public EntityModel<Map<String, String>> StudentApplicationNotFoundExceptionHandler(StudentApplicationNotFoundException except) {
